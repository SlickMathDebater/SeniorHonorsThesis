...
\begin{definition}
If $f$ is a continuous function, $n \in \N$, and $x \in \R$, then $S_n(f,x) = \sum\limits_{j=-n}^n c_n e^{ijx}$, where $c_n = \frac{1}{2 \pi} \int\limits_0^{2\pi} f(t)e^{-ijt} dt$. We call this the $n$-th partial sum of the Fourier series of $f$.
\end{definition}
...
So, we should try to build a sequence of uniformly bounded functions, $f_n$, such that $Mf_n \to \infty$; 
