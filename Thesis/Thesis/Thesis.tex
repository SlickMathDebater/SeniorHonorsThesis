...
\colorcomment{Green}{I need to make sure that I'm not wrong about the history here. Do we have a book I can reference or something?}
...
\colorcomment{Green}{How do I make this definition a sentence that isn't terrible?}
...
We then consider sets of continuous functions with some partial sum of its Fourier series larger than $n$ for each $n \in \N$.
...
\begin{thm}
$C(T)$ is a complete metric space. %Fix the sentence-starts-with-word thing.
\end{thm}
...
So, there are continuous functions such that \colorcomment{red}{Modulus of continuity is pretty bad}.
