...
\begin{thm}
\colorcomment{red}{If $f \in L^1[0, 2\pi]$, $x_0 \in f^{-1}([0,2\pi])$, and $\int\limits_{-\de}^{\de} \absval{\frac{f(x+x_0) - f(x_0)}{x}} < \infty$ for some $\de >0$, then the Fourier series of $f$ converges at $x_0$.}
\end{thm}
...
\begin{definition}
We say that $T = \R / 2\pi \Z$. %Fix formatting
\end{definition}
